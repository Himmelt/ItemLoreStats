...
public class Util_Colours {
   ...
   public String extractAndReplaceTooltipColour(String input) {
      String toolTipColour = input.replaceAll(ChatColor.RESET.toString(), "&r");
   ...
   public String replaceTooltipColour(String input) {
      String toolTipColour = input.replaceAll("%n", "        ");
      toolTipColour = toolTipColour.replaceAll("&r", "" + ChatColor.RESET);
      toolTipColour = toolTipColour.replaceAll("&o", "" + ChatColor.ITALIC);
      toolTipColour = toolTipColour.replaceAll("&n", "" + ChatColor.UNDERLINE);
      toolTipColour = toolTipColour.replaceAll("&m", "" + ChatColor.STRIKETHROUGH);
      toolTipColour = toolTipColour.replaceAll("&l", "" + ChatColor.BOLD);
      toolTipColour = toolTipColour.replaceAll("&k", "" + ChatColor.MAGIC);
      toolTipColour = toolTipColour.replaceAll("&f", "" + ChatColor.WHITE);
      toolTipColour = toolTipColour.replaceAll("&e", "" + ChatColor.YELLOW);
      toolTipColour = toolTipColour.replaceAll("&d", "" + ChatColor.LIGHT_PURPLE);
      toolTipColour = toolTipColour.replaceAll("&c", "" + ChatColor.RED);
      toolTipColour = toolTipColour.replaceAll("&b", "" + ChatColor.AQUA);
      toolTipColour = toolTipColour.replaceAll("&a", "" + ChatColor.GREEN);
      toolTipColour = toolTipColour.replaceAll("&9", "" + ChatColor.BLUE);
      toolTipColour = toolTipColour.replaceAll("&8", "" + ChatColor.DARK_GRAY);
      toolTipColour = toolTipColour.replaceAll("&7", "" + ChatColor.GRAY);
      toolTipColour = toolTipColour.replaceAll("&6", "" + ChatColor.GOLD);
      toolTipColour = toolTipColour.replaceAll("&5", "" + ChatColor.DARK_PURPLE);
      toolTipColour = toolTipColour.replaceAll("&4", "" + ChatColor.DARK_RED);
      toolTipColour = toolTipColour.replaceAll("&3", "" + ChatColor.DARK_AQUA);
      toolTipColour = toolTipColour.replaceAll("&2", "" + ChatColor.DARK_GREEN);
      toolTipColour = toolTipColour.replaceAll("&1", "" + ChatColor.DARK_BLUE);
      toolTipColour = toolTipColour.replaceAll("&0", "" + ChatColor.BLACK);
      return toolTipColour;
   }

   public String removeTooltipColour(String input) {
      String toolTipColour = input.replaceAll("&r", "");
